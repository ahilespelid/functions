...
if(!function_exists('svg')){function svg($file, string $default = null, array $attr = []){
    if(empty($file) || !is_string($file)){return $default;}
    $svg = (is_svg($file = img_path($file))) ? file_get_contents($file) : $default ?? '<svg class="text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>';
